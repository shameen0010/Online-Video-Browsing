...
<head>
    ...
    <title>Edit Customer Care Officer</title>
                ...
                <div class="max-w-4xl w-full mx-auto px-4">
                    <div class="form-container">
                        ...
                        <form id="editAdminForm" action="editAdmin" method="POST" onsubmit="return validateForm(event)">
                            ...
                            <div class="mb-4">
                                <label class="block text-sm text-gray-300">Password (Leave blank to keep unchanged)</label>
                                <input type="password" name="password" class="w-full p-2 bg-gray-700 rounded text-white">
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm text-gray-300">Confirm Password</label>
                                <input type="password" name="confirmPassword" class="w-full p-2 bg-gray-700 rounded text-white">
