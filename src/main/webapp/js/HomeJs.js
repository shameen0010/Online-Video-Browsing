(function (jQuery){
	...
	$(document).ready(function() {
	  // Initialize Magnific Popup for trailer videos
	  ...
	  // Existing slider initialization (example, adjust as needed)
	  $('#home-slider').slick({
	    dots: true,
	    infinite: true,
	    speed: 500,
	  ...
	  // Add other slider initializations from your original HomeJs.js here
